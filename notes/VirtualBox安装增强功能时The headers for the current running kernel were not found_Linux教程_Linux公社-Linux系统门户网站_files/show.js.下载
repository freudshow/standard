//Google DFP 广告 v2, 2016.12.06
var dfp_test = Math.random();
if (dfp_test > 0.5)
{
document.writeln("<script src='https://www.googletagservices.com/tag/js/gpt.js'></script>");
document.write("<script>");
document.write("googletag.cmd.push(function() {");
document.write("                   googletag.defineSlot('/1031423/dfp_test', [300, 250], 'div-gpt-ad-1479809035076-0').addService(googletag.pubads());");
document.write("                   googletag.pubads().enableSingleRequest();");
document.write("                   googletag.pubads().enableSyncRendering();");
...
//加入google dfp之前的show.js, 2016.12.06
